        ...
        <div class="card w-full h-auto bg-white rounded-md overflow-x-auto px-2 py-4">
            ...
            <form action="{{ route('dashboard.store') }}" method="post">
                ...
                <div class="mb-8 flex items-center bg-gray-100 ">
                    <input class="bg-gray-100 py-4 px-4 w-full rounded-md outline-none" type="text" name="organizerName" placeholder="Organizer Name" autocomplete="off" required>
                </div>
                <div class="image">
                    <div class="mb-6 flex items-center bg-gray-100 ">
                        <input class="bg-gray-100 py-4 px-4 w-full rounded-md outline-none" type="text" name="imageLocation" placeholder="Image Url" autocomplete="off">
                    </div>
                </div>
